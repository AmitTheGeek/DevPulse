...
class DefaultRepositoryCatalog(
    ...
    override suspend fun refreshRepositories(username: String): DataResult<Unit> =
        try {
    ...
    override suspend fun refreshRepository(owner: String, repositoryName: String): DataResult<Unit> =
        try {
